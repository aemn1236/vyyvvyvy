...
token = "6652860841:AAGldROsLD2US3epwlzfOcgYW58HrVdbsT0" #توكنك
bot = telebot.TeleBot(token, parse_mode="HTML")

@bot.message_handler(commands=['start'])
def start(message):
    buttons = types.InlineKeyboardMarkup(row_width=1)
    but1 = types.InlineKeyboardButton(text='المطور - Developer', url='https://t.me/DevEviI')
    but2 = types.InlineKeyboardButton(text='قناة المطور - Channel Developer', url='https://t.me/c35cs')
